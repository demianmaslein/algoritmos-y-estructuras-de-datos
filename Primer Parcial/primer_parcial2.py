from class_lista import List
from class_cola import Queue
from class_pila import Stack
...
superheroes.add_criterion("name", obtener_nombre)
superheroes.sort_by_criterion("name")
superheroes.show()

#2
posicion_thing = superheroes.search("The Thing", "name")
posicion_rocket = superheroes.search("Rocket Raccoon", "name")
print("The Thing está en la posición:", posicion_thing)
print("Rocket Raccoon está en la posición:", posicion_rocket)
...
superheroes.add_criterion("real_name", obtener_nombre_real)
superheroes.sort_by_criterion("real_name")
superheroes.show()

#7
def obtener_año_aparicion(personaje):
    return personaje["first_appearance"]

superheroes.add_criterion("first_appearance", obtener_año_aparicion)
superheroes.sort_by_criterion("first_appearance")
superheroes.show()

#8
posicion_antman = superheroes.search("Ant Man", "name")
if posicion_antman is not None:
    superheroes[posicion_antman]["real_name"] = "Scott Lang"
...
#10
electro = superheroes.delete_value("Electro", "name")
baron_zemo = superheroes.delete_value("Baron Zemo", "name")
